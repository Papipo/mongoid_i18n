...
This will allow you to do stuff like this:
  ...
  @entry.title_translation?(:en)
  @entry.title_translation?('en') # Check if the 'en' translation exists

The localized_field helper has two options (setted to false as default):
